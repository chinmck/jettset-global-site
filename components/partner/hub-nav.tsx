...
export function HubNav({ role }: { role: string }) {
  return <header className="hub-nav"><Link className="hub-brand" href="/partner/dashboard">Jettset Partner Hub</Link><nav className="hub-nav-links">
    <Link href="/partner/dashboard">Dashboard</Link><Link href="/partner/guests">My Guests</Link><Link href="/partner/enquiries/new">New enquiry</Link><Link href="/partner/commission">Commission</Link><Link href="/partner/resources">Resources</Link>
